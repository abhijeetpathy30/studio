...
export default function AboutPage() {
  return (
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 animate-in fade-in duration-500">
        <div className="max-w-4xl mx-auto">
          <Card className="shadow-lg border-primary/20">
            ...
            <CardContent className="space-y-6 text-lg text-foreground/80 leading-relaxed prose prose-lg max-w-none">
                ...
                <p>
                  The wise way started as a personal project to help me find clarity for the things on my own mind. It was a tool for my own curiosity, a way to easily access profound philosophical and spiritual knowledge whenever I felt stuck or needed a new perspective.
                </p>
                <p>
